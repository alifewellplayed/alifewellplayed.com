# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-11 10:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.TextField(blank=True, verbose_name='body')),
                ('body_html', models.TextField(blank=True)),
                ('channel', models.ForeignKey(blank=True, default=replica.pulse.models.DefaultChannel, null=True, on_delete=django.db.models.deletion.CASCADE, to='pulse.Channel', verbose_name='Entry Type')),
            ],
            options={
                'db_table': 'r_Entry',
                'ordering': ('-pub_date',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('content_type', models.PositiveSmallIntegerField(choices=[(0, 'embed'), (1, 'image'), (2, 'url')], default=1)),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
                ('title', models.CharField(max_length=510)),
                ...
                ('image', models.ImageField(blank=True, help_text='Support for PNG, JPG, GIF only', upload_to=replica.pulse.models.upload_media)),
                ('thumbnail_small', models.ImageField(blank=True, upload_to=replica.pulse.models.upload_media_sm)),
                ('thumbnail_medium', models.ImageField(blank=True, upload_to=replica.pulse.models.upload_media_md)),
