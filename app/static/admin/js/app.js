...
/***/ (function(module, exports, __webpack_require__) {
	...
	// router
	const routes = [{ path: '/', component: Home, name: 'Home' }, { path: '/settings', component: SiteSettings, name: 'SiteSettings' }, { path: '/editor', component: Editor, name: 'EntryNew' }, { path: '/editor/:entryID', component: Editor, name: 'EntryEdit' }, { path: '/pages', component: Pages, name: 'PagesList' }, { path: '/media', component: MediaGallery, name: 'MediaList' }, { path: '/entries', component: Entries, name: 'EntryList' }, { path: '/entries/:entryID', component: Entries, name: 'EntryDetail' }, { path: '/topics', component: Topics, name: 'TopicList' }, { path: '/topics/:id', component: TopicDetail, name: 'TopicDetail' }, { path: '/create/topic', component: TopicDetail }, { path: '/channels', component: Channels, name: 'ChannelList' }, { path: '/channels:id', component: ChannelDetail, name: 'ChannelDetail' }, { path: '/create/channel', component: ChannelDetail }, { path: '/404', component: NotFound, name: 'Error404' },

	//Contrib
	{ path: '/notes', component: NotesDashboard, name: 'NotesHome' }, { path: '/notes/status/:NoteID', component: Notes, name: 'NotesDetail' }];
